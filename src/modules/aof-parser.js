...
exports.parse = function(file, callback) {
    ...
    if (replayMetadata.version < 8) {
        console.log("The file is using an old data format");
    } else if (replayMetadata.version == 9) {
        console.log("This file is using a corrupted data format. Please report this to an administrator of aof.gg");
    }
    ...
    console.log("Opened replay file %s containing %s-%s @ %s", file, replayMetadata.regionId, replayMetadata.gameId, replayMetadata.riotVersion);
